...
describe('repositoryTest',()=>{
  ...
  expect(firstItemWithin.getByText('Build forms in React, without the tears')).toBeDefined();
  ...
  expect(secondItemWithin.getByText('async-library/react-async')).toBeDefined();
  expect(secondItemWithin.getByText('Flexible promise-based React data loader')).toBeDefined();
